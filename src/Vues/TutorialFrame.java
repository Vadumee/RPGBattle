...
public class TutorialFrame extends JFrame {
	...
	public TutorialFrame() {
		...
		tutorials.add("<html>L'onglet option te permet de sauvegarder ta progression, charger une sauvegarde, ou encore regarder le tuto (oh wait :D), tu peux tout simplement quitter le jeu dans un son déchirant de tristesse et d'adieu :'(<br>Il est aussi possible de cocher 'Selection de Carte auto' pour que la première carte soit automatiquement choisie lors de l'ouverture d'un paquet, sans que la fenêtre de choix ne s'ouvre.</html>");
