...
public class TutoSeasonFrame extends JFrame {
	...
	public TutoSeasonFrame() {
		...
		descriptions.add("<html>A chaque saison, il y a 5 serviteurs exclusifs à débloquer, tous légendaires. 4 d'entre eux sont des récompenses de pallier au score de saison, le dernier, surpuissant, nécessite d'effectuer la 'Conquête de Saison'.<br>La conquête de saison nécessite les requis suivants : <br>- Avoir obtenu 300.000 points au cours de la saison (augmentera à chaque saison)<br>- Avoir vaincu un boss de niveau 25 minimum (idem que pour les points).<br>- Avoir amélioré au minimum UN des quatre autres serviteurs de saison en qualité Super Mythique (seulement à partir de la saison 2).</html>");
		descriptions.add("");
