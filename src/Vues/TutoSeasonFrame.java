...
public class TutoSeasonFrame extends JFrame {
	...
	public TutoSeasonFrame() {
		...
		descriptions.add("<html>Chaque serviteur possède des statistiques qui lui sont propres : L'attaque (ATK) qui définit les dégats, ou 10% des heal si votre serviteur est soigneur.<br>La défense (DEF) définit la résistance de votre serviteur face aux attaques, elle est calculé en fonction de l'attaque ennemie.<br>La provocation (PROV) définit la chance de votre serviteur de se faire attaquer par l'ennemi.<br>L'agilité définie les chances de coups crititques, et 10% du heal si votre serviteur est soigneur.<br>Pour finir, la vitesse (VIT) définit les chances d'esquiver les attaques ennemies, elle offre aussi un multiplicateur de soins à certains pallier.</html>");
		...
		descriptions.add("<html>A chaque saison, il y a 4 serviteurs exclusifs à débloquer, tous légendaires. 3 d'entre eux sont des récompenses de pallier au score de saison, le dernier, surpuissant, nécessite d'effectuer la 'Conquête de Saison'.<br>La conquête de saison nécessite les requis suivants : <br>- Avoir obtenu 150.000 points au cours de la saison (augmentera de 20.000 chaque saison)<br>- Avoir vaincu un boss de niveau 15 minimum (idem que pour les points).<br>- Avoir amélioré au minimum UN des trois autres serviteurs de saison en qualité Super Mythique (seulement à partir de la saison 2).</html>");
		descriptions.add("");
